...
use super::{optional_list_arg, optional_str_arg, required_list_arg, required_str_arg};
...
starlark_module! { debian_module =>
    ...
    debian_control(
        ...
        required_list_arg("binary_packages", "DebianControlBinaryPackage", binary_packages)?;
